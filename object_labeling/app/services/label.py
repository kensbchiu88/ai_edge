...
class LabelService:
    ...
    def get_labels(self, streaming_id):
        ...
        for label_schema in label_schema_list:
            label_dto = LabelService.LabelDto(id=label_schema.id, streaming_data_id=label_schema.streaming_data_id, equipment_no=label_schema.equipment_no, x1=label_schema.x1, y1=label_schema.y1, x2=label_schema.x2, y2=label_schema.y2, type=label_schema.type)
